...
public class ScannerTest {
	public static void main(String[] args) {
		...
		System.out.print("취미 : ");
		String hobby=sc.nextLine(); // nextLine 전에 사용한 nextInt,next()가 없다면 굳이 버퍼를 비워주지 않아도됨!!
		...
		sc.nextLine(); //★버퍼를 비워주는 역할(항상 nextLine쓰기전에 버퍼 비워줬는지 확인하기!!)
		System.out.print("당신의 주소는 : ");
		String address = sc.nextLine(); // 입력한 문자열의 개행을 기준으로 값을 가져옴.
