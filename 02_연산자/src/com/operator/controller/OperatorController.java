...
public class OperatorController {
	...
	public void singleOp() {
		...
		public void calc() {
			...
			int su2 = sc.nextInt();
			System.out.println("첫번째 수 " + su + " 두번째 수 " + su2);
			int plus = su + su2;
			int minus = su - su2;
			int multiply = su * su2;
			double divide = su / (double)su2;
			System.out.println("더한결과 : " + plus);
			System.out.println("뺀결과 : " + minus);
			System.out.println("곱한결과 : " + multiply);
			System.out.println("나눈결과 : " + divide);
		}
...
//			//System.out.println(inputName=="유병승"); //★ == 기능은 String 문자의 주소값을 비교함
//			System.out.println(inputName.equals("유병승")); //★ equals 기능은 String 문자의 입력값을 비교함
...
//			System.out.println(!"유병승".equals(inputName));
			...
			String str = "30";
			String str2 = "40";
			// System.out.println(str<str2); 문자열은 대소비교가 불가능하다!!
		}
		//public void testStr()기능을 구현
		//사용자에게 id를 입력받고 아이디가 admin이면 true를 출력하는 기능
		
		//public void check()기능 구현
		//사용자에게 나이를 입력받고 성년이면 true 출력하는 기능
		
		public void testStr() {
			Scanner sc = new Scanner(System.in);
			System.out.print("id를 입력하세요 : ");
			String str = sc.nextLine();
			System.out.println(str + " : " +str.equals("admin"));
		...
		public void logicOp() {
			...
			// && : and(그리고) 두개의 진위형이 모드 true일때 true반환
			// || : or(또는) 두개의 진위형 중 1개가 true일때 true반환
			...
			boolean flag = (address.equals("서울")|| address.equals("인천"))&& 30 <= age && age <=39; //논리연산자 우선순위 주의!!
		...
		public void thirdOp() {
			...
			//값이 180보다 크면 키가 크네요출력 아니면 키가 작네요출력
			...
			//아이디와 패스워드를 입력받고
			//아이디가 admin이고 패스워드가 1234면 로그인 성공출력 아니면 로그인 실패출력
			System.out.print("아이디 : ");
			sc.nextLine();
			String userId = sc.nextLine();
			System.out.print("패스워드 : ");
			String password = sc.nextLine();
			String result2 = userId.equals("admin") && password.equals("1234") ? "로그인 성공" : "로그인 실패";
			System.out.println(result2);
...
//			+(userId.equals("admin")?"checked":"")+">";
		...
		public void bitOperator() {
			...
			//A | B : 두개 중 한개가 1일때 1값을 출력 두값으 모두 0일때 0을 출력
			//A ^ B(XOR) : 두비트가 다른값을 가질때 1출력 같은 값일때 0을 출력
			//~A : 보수 *값을 반전 1 -> 0, 0 -> 1로 변경
