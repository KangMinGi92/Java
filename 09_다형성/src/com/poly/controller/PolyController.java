...
public class PolyController {
	...
	public void basicTest() {
		...
		ptp = new PolyTest(); // 상속관계일때 타입이 다르지만 저장가능!!
		ptp = new PolyTest2();
...
//		printPerson(new PolyTest());
	...
	public void objArrPolyTest() {
		...
		for (Person p : ageSearch) {
			if (p != null) { // 이구문이 없으면 nullPoint 에러 발생!!
		...
		System.out.println(
				"학생 : " + studentCount + " 선생 : " + teacherCount + " 직원 : " + employeeCount + " 총인원 : " + count);
	}
	...
	public void abstractClassTest() {
		...
		//act=new AbstractClassTest(); //추상클래스는 직접 객체화해서 사용 할 수 없다.
