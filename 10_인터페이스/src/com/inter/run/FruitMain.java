...
public class FruitMain {
	...
	public static void main(String[] args) {
		...
		result=searchWeight(fruits,2.1);
		System.out.println(Arrays.toString(result));
		result=searchPrice(fruits,20000);
		System.out.println(Arrays.toString(result));
		...
		result=searchFruit(fruits,3.0,(Fruit f, Object data)->f.getWeight()>=(double)data);//람다형으로 표현하기
		System.out.println(Arrays.toString(result));
		
		result=searchFruit(fruits,"사과",(f, data)->f.getName().equals(data)); //f,data 자료형 생략 가능
		System.out.println(Arrays.toString(result));
