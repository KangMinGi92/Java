...
public class ExceptionController {
	...
	public void uncheckedException() {
		...
		//ArithmeticException : 수학적으로 계산이 불가능할때 발생하는 Exception
		int su=10;
		int su2=0;
		//System.out.println(su/su2); 0으로 나눠서 에러발생
		...
		//NullPointException
		//참조형 변수에 null값이 있을때 접근연산자를 사용하면 발생하는 Exception
		String name=null;
		//name.length();
		
		//NumberFormatException
		//문자열을 숫자형으로 변환할때 변환불가능한 문자가 있는 경우
		//su=Integer.parseInt(name);
		
		//InputMissMatchException
		//입력값의 타입이 일치하지 않을때 발생
...
//		}
		...
		//부모Exception은 자식 Exception이 발생했을때 모두 처리 할 수 있다.
